...
namespace Wonderland
{
    ...
    {
        // APIs
        public static readonly Logger Auth = new (Debug.unityLogger.logHandler);
        public static readonly Logger Firestore = new (Debug.unityLogger.logHandler);
        
        // Network
        public static readonly Logger Network = new (Debug.unityLogger.logHandler);
